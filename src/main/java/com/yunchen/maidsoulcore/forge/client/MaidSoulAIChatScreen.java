...
import com.yunchen.maidsoulcore.forge.network.MaidSoulOwnerChatPacket;
...
public final class MaidSoulAIChatScreen extends AIChatScreen {
    ...
    private EditBox input() {
        ...
        try {
            ...
            MaidSoulCoreMod.LOGGER.warn("Failed to access TLM AIChatScreen input field for MaidSoulCore chat.", e);
            return null;
        }
    }
    ...
    private static Field findInputField() {
        try {
            ...
            MaidSoulCoreMod.LOGGER.warn("TLM AIChatScreen input field was not found; MaidSoulCore chat send will be disabled.", e);
            return null;
        }
    }
}
