...
public final class MaidSoulTlmBootstrapper {
    ...
    private static void ensureTlmChatGateOpen() {
        try {
            ...
            MaidSoulCoreMod.LOGGER.warn("Failed to adjust TLM AI chat gate for MaidSoulCore bridge.", e);
        }
    }
    ...
    public static void ensureRuntimeSite() {
        ...
        if (site == null) {
            ...
            MaidSoulCoreMod.LOGGER.info("Injected MaidSoulCore runtime site into TLM AvailableSites: {}", MaidSoulRuntimeSite.API_TYPE);
            return;
        }
        if (!site.enabled()) {
            site.setEnabled(true);
            MaidSoulCoreMod.LOGGER.info("Re-enabled MaidSoulCore runtime site in TLM AvailableSites: {}", MaidSoulRuntimeSite.API_TYPE);
        }
    }
    ...
    public static void ensureRuntimeSerializer() {
        ...
        MaidSoulCoreMod.LOGGER.info("Injected MaidSoulCore runtime serializer into TLM SerializerRegister: {}", MaidSoulRuntimeSite.API_TYPE);
    }
